...
--
-- Host: 127.0.0.1
-- Creato il: Ott 12, 2021 alle 21:15
...
(5, '2021-10-12 17:07:36'),
(6, '2021-10-12 17:08:28'),
(7, '2021-10-12 17:34:36');
...
INSERT INTO `ordini` (`id_ordine`, `id_carrello1`, `id_anagrafica_cliente`, `importo`, `data_consegna`) VALUES
(2, 1, 2, 5000, '2021-10-15 00:00:00'),
(3, 7, 2, 464.49, '2021-10-27 19:34:43');
...
(2, 'RAM Samsung', 'https://m.media-amazon.com/images/I/71JOuGEq0xL._AC_SS450_.jpg', 'BL2K8G32C16U4B 3200 MHz, DDR4, DRAM, Memoria Gaming Kit per Computer Fissi, 16GB (8GB x2), CL16, Nero', '10', 3, 1, 70, 85, 1, NULL),
...
(4, 'Lol Pc Elite Gaming', 'https://m.media-amazon.com/images/I/51jPaXP+YML._AC_.jpg', '-AMD Ryzen™ 7 5700G Processore\r\n-RAM Samsung (x2)\r\n-8 GB 2Rx8 PC3L-12800S RAM\r\n-Cooler Master MasterCase H500P Mesh\r\n-Asus prime x570-p\r\n-SanDisk Ultra 3d SSD 4TB\r\n-MSI V375-035R scheda video GeForce RTX 2060 Ventus\r\n-MARS GAMING MPII650,ALIMENTATORE PC 650W', '123456789123', 0, 0, 1600, 600, NULL, 5),
(6, 'Dragon Metal ', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQseSNcoG3OL6X41ZNc3fI-g47qH-JZgNknWA&usqp=CAU', '-AMD Ryzen™ 7 5700G Processore\r\n-Scheda Grafica GeForce RTX™ 3090 24GB\r\n-Cooler Master MasterBox 5 MSI Gaming Edition Case\r\n-SanDisk Ultra 3d SSD 4TB\r\n-Aorus b450 pro wifi\r\n-MSI MPG A850GF 850WATT\r\n-Memoria Kingston FURY Beast  16 GB DDR4 RGB  (x2)', '856754123', 1, 0, 3800, 5000, 2, 6),
(7, 'Cooler Master MasterBox TD500', 'https://m.media-amazon.com/images/I/81PSVjYuWNL._AC_SX466_.jpg', 'Cooler Master MasterBox TD500 Mesh White - Case PC ARGB in Bianco con Rete Mesh Poligonale, 3 x 120mm Ventole Preinstallate, Panello Laterale Vetro, Configurazioni Flessibili Air Flow -Colore Bianco', '42364628', 2, 0, 42, 64, 2, NULL),
(8, 'Cooler Master MasterCase H500P Mesh', 'https://m.media-amazon.com/images/I/91vIa7kin+L._AC_SX466_.jpg', 'Cooler Master MasterCase H500P Mesh – Case PC RGB con Due Ventole da 200 mm Ottimo Flusso d\'Aria, Pannelli Fatti per Costruttori, Predisposto per Dissipazione a Liquido', '145632345211', 1, 1, 230, 301, 2, NULL),
...
(25, 'GAMDIAS ASTRAPE M1-650W RGB ALIMENTATORE ATX', 'https://m.media-amazon.com/images/I/71o4AuKuyXL._AC_SX425_.jpg', 'GAMDIAS Astrape M1-650B RGB Alimentatore ATX Pc Desktop da Gaming 650 Watt 80 Plus Bronzo Ventola RGB Rainbow 120 mm PFC Attivo (Astrape M1, 650W 80+ Bronze)', '3458900', 3, 1, 100, 198, NULL, NULL),
...
INSERT INTO `prodotti_nel_carrello` (`id_prodotto_nel_carrello`, `id_prodotto1`, `id_carrello`) VALUES
(8, 1, 5),
(9, 1, 5),
(10, 3, 5),
(11, 6, 6),
...
--
ALTER TABLE `prodotti_nel_carrello`
  MODIFY `id_prodotto_nel_carrello` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `ordini`
  ADD CONSTRAINT `id_anagrafica_cliente` FOREIGN KEY (`id_anagrafica_cliente`) REFERENCES `anagrafica_clienti` (`id_anagrafica_clienti`),
  ADD CONSTRAINT `id_carrello1` FOREIGN KEY (`id_carrello1`) REFERENCES `carrello` (`id_carrello`);

--
-- Limiti per la tabella `prodotti`
--
ALTER TABLE `prodotti`
  ADD CONSTRAINT `id_anagrafica_fornitore` FOREIGN KEY (`id_anagrafica_fornitore`) REFERENCES `anagrafica_fornitori` (`id_anagrafica_fornitori`),
  ADD CONSTRAINT `id_assemblato` FOREIGN KEY (`id_assemblato`) REFERENCES `assemblati` (`id_assemblato`);

--
-- Limiti per la tabella `prodotti_assemblato`
--
ALTER TABLE `prodotti_assemblato`
  ADD CONSTRAINT `id_assemblato1` FOREIGN KEY (`id_assemblato1`) REFERENCES `assemblati` (`id_assemblato`),
...
ALTER TABLE `prodotti_nel_carrello`
  ...
  ADD CONSTRAINT `id_prodotto1` FOREIGN KEY (`id_prodotto1`) REFERENCES `prodotti` (`id_prodotto`);
COMMIT;
