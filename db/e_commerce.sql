...
--
-- Host: 127.0.0.1
-- Creato il: Ott 09, 2021 alle 16:49
...
(1, '2021-10-05 22:00:00'),
(2, '2021-10-05 22:00:00');
...
(4, 'Pc Pincopallo', 'https://m.media-amazon.com/images/I/51jPaXP+YML._AC_.jpg', 'Pc assemblato', '123456789123', 0, 0, NULL, 600, NULL, 5),
(6, 'Dragon Metal ', 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQseSNcoG3OL6X41ZNc3fI-g47qH-JZgNknWA&usqp=CAU', 'Da aggiungere in base ai pezzi che abbiamo', '856754123', 1, 0, 1800, 2400, 2, 6),
...
INSERT INTO `prodotti_nel_carrello` (`id_prodotto_nel_carrello`, `id_prodotto`, `id_carrello`) VALUES
(1, 1, NULL),
(2, 1, 2),
(3, 4, 2);
...
--
ALTER TABLE `prodotti_assemblato`
  MODIFY `id_componenti_assemblato` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
